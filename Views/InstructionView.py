...
class InstructionView(arcade.View):
    ...
    def on_draw(self):
        arcade.start_render()
        arcade.draw_text("Instructions Screen", SCREEN_WIDTH/2, SCREEN_HEIGHT - 2*SCREEN_HEIGHT/10,
                         arcade.color.BLACK, font_size=50, anchor_x="center")
        arcade.draw_text("You look like this: ", SCREEN_WIDTH/20, SCREEN_HEIGHT- 3.5*SCREEN_HEIGHT/10,
                         arcade.color.BLACK, font_size=16, anchor_x="left")
        arcade.draw_text("The monsters look like this: ", SCREEN_WIDTH/20, SCREEN_HEIGHT- 4.5*SCREEN_HEIGHT/10,
                         arcade.color.BLACK, font_size=16, anchor_x="left")
